...
{
    #[OA\Get(path: '/api/v1/administration/tableau-de-bord', tags: ['Administration'], security: [['sanctum' => []]], responses: [new OA\Response(response: 200, description: 'Tableau de bord administration')])]
